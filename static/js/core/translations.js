...
export const TRANSLATIONS = {
  en: {
    ...
    createRouteFromHistory: "Create Route from History",
    reloadRoutes: "Reload Routes",
    toggleRoutesVisibility: "Toggle Visibility",
    routeStats: "Statistics",
  ...
  es: {
    ...
    noGeofencesCreated: "No se han creado geocercas aún",
    ...
    geofenceDescription: "Descripción",
    geofenceArea: "Área",
    devicesInGeofence: "Dispositivos Dentro",
    lastAlert: "Última Alerta",
    deleteGeofence: "Eliminar Geocerca",
    confirmDelete: "¿Está seguro de que desea eliminar esta geocerca?",
    enterGeofenceName: "Ingrese nombre de geocerca",
    enterDescription: "Ingrese descripción (opcional)",
    created: "Creado",
    updated: "Actualizado",
    ...
    geofenceAreaKm: "km²",
    deviceEntered: "Dispositivo entró a geocerca",
    deviceExited: "Dispositivo salió de geocerca",
    ...
    createRouteFromHistory: "Crear Ruta desde Historial",
    reloadRoutes: "Recargar Rutas",
    toggleRoutesVisibility: "Alternar Visibilidad",
    routeStats: "Estadísticas",
    totalRoutes: "Total de Rutas",
    totalDistance: "Distancia Total",
    activeRoutes: "Rutas Activas",
    noRoutesCreated: "No se han creado rutas aún",
